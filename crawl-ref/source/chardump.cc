...
static void _json_sdump_hunger(json_dump_params &);
...
static void _json_sdump_hunger(json_dump_params &jpar)
{
    json_append_member(jpar.json, "hunger", json_mkstring(hunger_level()));
}
...
static JsonNode *_json_sdump_turns_place_info(const PlaceInfo place_info, string name = "")
{
    ...
    json_append_member(turns_place_info, "spentPercent", json_mknumber(a));
    json_append_member(turns_place_info, "nonInterLevelTravelPercent", json_mknumber(b));
    json_append_member(turns_place_info, "interLevelTravelPercent", json_mknumber(c));
    json_append_member(turns_place_info, "restPercent", json_mknumber(d));
    json_append_member(turns_place_info, "autoExploring", json_mknumber(e));
    json_append_member(turns_place_info, "spentProportion", json_mknumber(f));
